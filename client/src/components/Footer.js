      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Машинное обучение</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Центр помощи</a></li>
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Партнёры</a></li>
        ...
        <div className="border-t border-gray-800 pt-8 mt-8 text-center">
          <p className="text-gray-400">
            © 2026 VYKOD. Все права защищены. Сделано с заботой о разработчиках.
          </p>
        </div>
      </div>
    </footer>
